...
import peresentation.base.components.main.components.statistics.components.statisticHeader
...
class StatisticRepositoryImpl : StatisticRepository {
    ...
    private fun getStatistic(financier: String,year: Int, month: Int) : Flow<Int> {
        return flow {
            ...
            transaction {
                StatisticEntity.select{(StatisticEntity.year eq year) and (StatisticEntity.month eq month) and (StatisticEntity.financier eq financier)}.forEach {
